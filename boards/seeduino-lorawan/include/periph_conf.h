 ...
 *
 * @file
 * @brief       Configuration of CPU peripherals for Seeduino-Lorawan board
 *
...
static const pwm_conf_t pwm_config[] = {
    ...
    {TCC0, {
        ...
        { GPIO_PIN(PA, 9), GPIO_MUX_E, 1},    /* ~2 */
        { GPIO_PIN(PA, 15), GPIO_MUX_F, 5 },    /* ~3 */
        { GPIO_PIN(PA, 20), GPIO_MUX_F, 6 },    /* ~3 */
    }}
#endif
};
...
static const uart_conf_t uart_config[] = {
    {
        /* arduino header, RHF76 LoRa module*/
        .dev      = &SERCOM0->USART,
        .rx_pin   = GPIO_PIN(PA,11),  /* ARDUINO_PIN_0, RX Pin */
        .tx_pin   = GPIO_PIN(PA,10),  /* ARDUINO_PIN_1, TX Pin */
...
static const spi_conf_t spi_config[] = {
    {
        .dev      = &SERCOM1->SPI,
        .miso_pin = GPIO_PIN(PA, 19),   /* ARDUINO_PIN_12, SERCOM1-MISO */
        .mosi_pin = GPIO_PIN(PA, 16),   /* ARDUINO_PIN_11, SERCOM1-MOSI */
        .clk_pin  = GPIO_PIN(PA, 17),   /* ARDUINO_PIN_13, SERCOM1-SCK */
        .miso_mux = GPIO_MUX_C,
        .mosi_mux = GPIO_MUX_C,
        .clk_mux  = GPIO_MUX_C,
